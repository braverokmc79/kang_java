...
public class TimeExam {
	...
	public static void main(String[] args) {
		...
		System.out.println(timePoint); //2017-09-21T07:29:05.259
		...
		System.out.println(theDate); //2017-09-21
		System.out.println(timePoint.getMonthValue()); //9
		
		Month month =timePoint.getMonth();
		System.out.println(timePoint.getMonth());//SEPTEMBER
